...
import { addToCartService, getCartService, removeFromCartService } from "../Services/CartServices";
...
export const CartProvider = ({children}) => {
    ...
    const findItemInCart = (productId) => cartState.cart.find((item) => item.id === productId) 
    ...
    return <CartContext.Provider value={{cartState, cartDispatch, loading, addToCart, findItemInCart, removeFromCart, quantityInCart, clearCart, totalPrice}}>{children}</CartContext.Provider>
}
